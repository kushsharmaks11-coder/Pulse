  ...
  return (
    <div className="p-8 max-w-4xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-sm text-gray-500 mt-1">Enter the details for the new service or project.</p>
      </div>
      ...
      <form action={createOrderAction} className="space-y-8">
            ...
            <div className="md:col-span-2">
              ...
              {clients.length === 0 && (
                <p className="text-sm text-amber-600 mt-2">
                  You need to <Link href="/clients/new" className="underline font-medium">add a client</Link> before creating an order.
                </p>
              )}
            </div>
